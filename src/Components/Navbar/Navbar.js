...
const Navbar = () => {
  ...
  return (
    <nav className="nav">
        ...
        <ul className={active}>
          <Link spy={true} to="home" smooth={false} activeClass="activeClass">
            <li className="nav_item ty"><a href='#' className="nav_link active-link">
              Home
            </a></li>
            </Link>
            <Link spy={true} to="about" smooth={false} >
            <li className="nav_item tys"><a href='#' className="nav_link">
              About
              </a></li>
              </Link>
              <Link spy={true} to="skills" smooth={false} >
            ...
            <li className="nav_item tyi"><a href='#' className="nav_link">
              ...
              <Link spy={true} to="faqs" smooth={false} >
